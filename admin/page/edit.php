...
<div class="page-content">
    ...
    <div class="header-elements" style="display: flex; justify-content: flex-end; align-items: center; width: 100%; margin-top: 0px; margin-bottom: 0px; padding-top: 0px; padding-bottom: 0px; ">
        <!-- back button -->
        <a href="../page/index.php" class="btn btn-primary" style="margin-top: 0px; margin-bottom: 0px; padding-top: 0px; padding-bottom: 0px; ">Back</a>
    </div>
</div>
							...
							<form action="update_post_script.php" method="post" enctype="multipart/form-data">
										...
										<div class="col-md-2">
											<div class="form-group">
												...
												<select name="is_active" class="form-control form-control-sm" required>
													<option value="1" <?=($currdata['is_active'] == 1) ? "selected" : ""; ?>>Active</option>
													<option value="0" <?=($currdata['is_active'] == 0) ? "selected" : ""; ?>>Inactive</option>
												</select>
											</div>
										</div>
