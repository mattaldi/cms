...
$sql = "SELECT DISTINCT YEAR(created_date) as year FROM posts ORDER BY year DESC";
$result = $db->query($sql);
$years = $db->fetchAll($result);


$sql = "SELECT DISTINCT MONTH(created_date) as month FROM posts ORDER BY month";
$result = $db->query($sql);
$months = $db->fetchAll($result);
...
$sql = "SELECT * FROM posts WHERE category='blog_detail'";
